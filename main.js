...
function draw(){
    check_sketch();
    if(drawn_sketch==drawing){
        answer_holder="set";
        score=score++;
        document.getElementById("score_won").innerHTML='Score: '+score;
    }
    strokeWeight(8);
    stroke(0);
    if(mouseIsPressed){
...
function check_sketch(){
    ...
    if(timer_check=='completed'||answer_holder=='0'){
        timer_check="";
        answer_holder="";
        update_canvas();
    }
...
function gotResult(error, results){
    ...
    document.getElementById('guessed_sketch').innerHTML='Your Sketch Is: '+results[0].label;
